      ...
      <div className="bg-gradient-to-r from-purple-900/50 to-pink-900/50 border-b border-purple-900/30 px-4 py-4">
        <div className="max-w-3xl mx-auto flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs bg-purple-600/30 text-purple-300 px-2 py-0.5 rounded-full">Sample Result</span>
          </div>
          <button
            onClick={() => navigate('/')}
            ...
            {sample.roadmap.map((phase, i) => (
              <div key={i} className="flex gap-4">
                <div className="flex flex-col items-center">
                  ...
                  {i < sample.roadmap.length - 1 && <div className="w-0.5 bg-purple-900 flex-1 mt-1" />}
                </div>
                <div className="pb-4">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-[#1A1A2E] rounded-xl p-4">
              ...
              <p className="text-gray-300 text-sm">{sample.team_style}</p>
            </div>
            <div className="bg-[#1A1A2E] rounded-xl p-4">
              <div className="text-purple-400 text-sm font-semibold mb-1">🏢 Ideal Work Environment</div>
              <p className="text-gray-300 text-sm">{sample.ideal_work_environment}</p>
            </div>
          </div>
        </motion.div>
